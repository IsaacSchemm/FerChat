        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connection.invoke("SendMessage", this.chatRoomId, this.textEntry())];
                    case 1:
                        _a.sent();
                        this.textEntry("");
                        return [3 /*break*/, 3];
...
var chatRoom = new ChatRoom(document.getElementById("chatRoomId").value);
...
(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, connection.invoke("joinChatRoom", chatRoom.chatRoomId)];
            case 2:
                _a.sent();
